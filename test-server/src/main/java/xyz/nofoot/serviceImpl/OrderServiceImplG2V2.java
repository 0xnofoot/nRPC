 ...
 * @description: TODO
 */
@RpcService(group = "g2", version = "v2")
@Slf4j
public class OrderServiceImplG2V2 implements OrderService {

    @Override
    public String getOrder(Order order) {
        log.info("OrderServiceG2V2-getOrder");
    ...
    public Integer toPay(Order order) {
        log.info("OrderServiceG2V2-toPay");
    ...
    public Boolean isPay(Order order) {
        log.info("OrderServiceG2V2-isPay");
        Boolean isPay = order.getIsPay();
        log.info("执行结果：[{}]", isPay);
        return isPay;
    }
    ...
    public String generateOrder(Order order) {
        log.info("OrderServiceG2V2-generateOrder");
        String result = "order1-G2-V2";
        log.info("执行结果：[{}]", result);
        return result;
    }
    ...
    public String sayHello(Order order) {
        log.info("OrderServiceG2V2-sayHello");
