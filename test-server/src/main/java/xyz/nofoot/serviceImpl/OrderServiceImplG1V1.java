...
@Slf4j
public class OrderServiceImplG1V1 implements OrderService {
    @Override
    public String getOrder(Order order) {
        log.info("OrderServiceG1V1-getOrder");
    ...
    public Integer toPay(Order order) {
        log.info("OrderServiceG1V1-toPay");
    ...
    public Boolean isPay(Order order) {
        log.info("OrderServiceG1V1-isPay");
        Boolean isPay = order.getIsPay();
        log.info("执行结果：[{}]", isPay);
        return isPay;
    }
    ...
    public String generateOrder(Order order) {
        log.info("OrderServiceG1V1-generateOrder");
        String result = "order1-G1-V1";
        log.info("执行结果：[{}]", result);
        return result;
    }
    ...
    public String sayHello(Order order) {
        log.info("OrderServiceG1V1-sayHello");
